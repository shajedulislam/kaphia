    ...
    builder: (_) {
      return Padding(
        padding: EdgeInsets.symmetric(
          horizontal: ProDesign.horizontally(8),
          vertical: ProDesign.horizontally(5),
        ),
        child: Scaffold(
          backgroundColor: Colors.transparent,
          body: Align(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    borderRadius: customBorderRadius ??
                        BorderRadius.all(Radius.circular(ProDesign.pt(12))),
                    child: customAppBar ??
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ProText(
                                ...
                                fontWeight:
                                    appBarTitleWeight ?? FontWeight.w700,
                              ),
                              InkWell(
                                onTap: () {
